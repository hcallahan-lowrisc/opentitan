# Earl Grey Design Specification

For a brief overview, refer to the [OpenTitan Earl Grey Chip Datasheet](../datasheet.md).

# Overview

OpenTitan Earl Grey is a secure microcontroller, based around a central [Ibex](https://github.com/lowrisc/ibex) RISC-V (`rv32imcb`) CPU core with a number of security, cryptographic, communication and utility peripherals and coprocessors. Internal ROM, embedded Flash, SRAM and OTP memories exist within the SoC to meet the trust-model.
A TileLink Uncached Lightweight (TL-UL) bus with bridged high-speed and low-speed domains forms the backbone of the Earl Grey system, but seperate, isolated networks exist within the system to [handle keys](../../../ip/keymgr/README.md) securely and to [distribute entropy](#entropy-distribution-network) of different levels of quality.
Peripherals used in Earl Grey have been developed as part of the OpenTitan project, and exist within the common repository. All peripherals are *Comportable*, which means they follow the [Comportability Guidelines](../../../../doc/contributing/hw/comportability/README.md) for lowRISC peripheral IP. We refer to these as Hardware IP (HWIP) blocks.

Each HWIP block has its own specification.
See the table on the [hardware homepage](../../../README.md) for links to those specifications.

Ibex was initially developed as part of the PULP platform under the name "Zero-riscy", and has been contributed to lowRISC who maintains it and develops it further. It is under active development, and has seen multiple tape-outs. As Ibex pre-dates OpenTitan, it is developed as a standalone project in its own lowRISC [repository](https://github.com/lowrisc/ibex), and is [*vendored in*](../../../../doc/contributing/hw/vendor.md) to this repository for use within OpenTitan Earl Grey.

# Theory of Operations

## Clocking and Reset

Clocks and resets are supplied from the Analog Sensor Top, commonly abbreviated to the [ast](../../ip/ast/README.md).
...
- `chip_earlgrey_cw310` for use in FPGA
- `chip_earlgrey_asic` for use in a silicon implementation
