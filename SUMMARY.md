...
- [Device Software](./sw/device/README.md)
  - [Build & Test Rules](./rules/opentitan/README.md)
    - [Top selection](./hw/top/README.md)
      ...
      - [Rules]()
        - [defs.bzl](./hw/top/defs.bzl)
        - [extensions.bzl](./hw/top/extensions.bzl)
...
- [//rules]()
  - [/opentitan]()
    - [CC](./rules/opentitan/cc.bzl)
    - [CI](./rules/opentitan/ci.bzl)
    - [Defs](./rules/opentitan/defs.bzl)
    - [Execution Environments](./rules/opentitan/exec_env.bzl)
      - [FPGA](./rules/opentitan/fpga.bzl)
      - [QEMU](./rules/opentitan/qemu.bzl)
      - [Silicon](./rules/opentitan/silicon.bzl)
      - [Sim_DV](./rules/opentitan/sim_dv.bzl)
      - [Sim_Verilator](./rules/opentitan/sim_verilator.bzl)
    - [HW](./rules/opentitan/hw.bzl)
    - [Keyutils](./rules/opentitan/keyutils.bzl)
    - [Legacy](./rules/opentitan/legacy.bzl)
    - [Manual](./rules/opentitan/manual.bzl)
    - [Providers](./rules/opentitan/providers.bzl)
    - [Splice](./rules/opentitan/splice.bzl)
    - [Static_library](./rules/opentitan/static_library.bzl)
    - [Toolchain](./rules/opentitan/toolchain.bzl)
    - [Transform](./rules/opentitan/transform.bzl)
    - [Util](./rules/opentitan/util.bzl)
  - [Autogen](./rules/autogen.bzl)
  - [Bitstreams](./rules/bitstreams.bzl)
  - [Certificates](./rules/certificates.bzl)
  - [Const](./rules/const.bzl)
  - [Cross-Platform](./rules/cross_platform.bzl)
  - [Doxygen](./rules/doxygen.bzl)
  - [Extensions](./rules/extensions.bzl)
  - [Files](./rules/files.bzl)
  - [Fusesoc](./rules/fusesoc.bzl)
  - [Host](./rules/host.bzl)
  - [LC](./rules/lc.bzl)
  - [Linker](./rules/linker.bzl)
  - [Manifest](./rules/manifest.bzl)
  - [Quality](./rules/quality.bzl)
  - [Repo](./rules/repo.bzl)
  - [ROM_E2E](./rules/rom_e2e.bzl)
  - [Rust](./rules/rust.bzl)
  - [RV](./rules/rv.bzl)
  - [Signing](./rules/signing.bzl)
  - [Stamp](./rules/stamp.bzl)
  - [Tock](./rules/tock.bzl)
  - [UJSON](./rules/ujson.bzl)
